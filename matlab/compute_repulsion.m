%计算斥力分程序：
%斥力计算 
function [Yrerxx,Yreryy,Yataxx,Yatayy]=compute_repulsion(X,Xsum,m,angle_at,angle_re,n,Po,a)%输入参数为当前坐标，Xsum是目标和障碍的坐标向量，增益常数,障碍，目标方向的角 度
...
Yata(i)=0.5*a*m*((1/rre(i)-1/Po)^2)*(rat^(a-1));%分解的Fre2向量
